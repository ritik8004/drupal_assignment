@javascript @auth @exclusive-coupon @guest @bbwkwuat
Feature: SPC to add Exclusive coupon & get discount in cart page for Guest user

  Background:
    Given I am on homepage

  @desktop @free-gift
  Scenario: As a Guest User, I should be able to add Exclusive coupon code on the Free Gift product
  ...
  Scenario: As a Guest User, I should be able to add Exclusive coupon code on the discounted price for PDP
    ...
    And I should not see an "div.spc-product-price .price-block div.has--special--price" element
    And I verify the wishlist popup block if enabled and remove the cart item
    And I wait for element "div.spc-empty-container"
    Then I should see an "#spc-cart .spc-empty-text" element
  ...
  @desktop @bbwfixed
  Scenario: As a Guest User, I should be able to add Exclusive fixed amount coupon & get discount directly on the Cart page
  ...
  @desktop @bbw-dynamic
  Scenario: As a Guest User, I should be able to add Exclusive coupon code and the Dynamic promotion not be applicable
    ...
    And I wait for AJAX to finish
    Then I should see an ".totals .discount-total" element
    And I verify the wishlist popup block if enabled and remove the cart item
    And I wait for element "div.spc-empty-container"
    Then I should see an "#spc-cart .spc-empty-text" element
  ...
  @language @free-gift
  Scenario: As a Guest User, I should be able to add Exclusive coupon code on the Free Gift product in Arabic
    When I am on "{spc_free_gift}"
    And I wait for element "#block-content"
  ...
  Scenario: As a Guest User, I should be able to add Exclusive coupon code on the discounted price for PDP in Arabic
    When I am on "{spc_discounted_pdp_page}"
    And I wait for element "#block-content"
    When I follow "{language_link}"
    And I wait for element "#block-content"
  ...
  Scenario: As a Guest User, I should be able to add Exclusive coupon code and the Dynamic promotion not be applicable in Arabic
    When I am on "{spc_multiple_product_detail_page_coupon}"
    And I wait for element "#block-content"
    When I follow "{language_link}"
    And I wait for element "#block-content"
 ...
 @mobile @free-gift
 Scenario: As a Guest User, I should be able to add Exclusive coupon code on the Free Gift product for Mobile
   When I am on "{spc_free_gift}"
   And I wait for element "#block-content"
   And I click on Add-to-cart button
   And I wait for AJAX to finish
 ...
 Scenario: As a Guest User, I should be able to add Exclusive coupon code on the discounted price for PDP for Mobile
   When I am on "{spc_discounted_pdp_page}"
   And I wait for element "#block-content"
   And I click on Add-to-cart button
   And I wait for AJAX to finish
 ...
 @mobile @bbwfixed
 Scenario: As a Guest User, I should be able to add Exclusive fixed amount coupon & get discount directly on the Cart page for Mobile
   When I am on "{spc_single_product_detail_page_coupon}"
   And I wait for element "#block-content"
   And I click on Add-to-cart button
   And I wait for AJAX to finish
 ...
 @mobile @bbw-dynamic
 Scenario: As a Guest User, I should be able to add Exclusive coupon code and the Dynamic promotion not be applicable for Mobile
   When I am on "{spc_multiple_product_detail_page_coupon}"
   And I wait for element "#block-content"
   And I click on Add-to-cart button
   And I wait for AJAX to finish
