@javascript @dynamic-promotion @discount @smoke @flaeuat @vssauat
Feature: SPC to add dynamic promotions (Buy 2 Get 1 free) or (Add 2 more to get x% discount) for Guest user
  ...
  Scenario: As a Guest User, I should be able to add dynamic promotions like (Add 3 more to get x% discount) on cart page
  ...
  Scenario: As a Guest User, I should be able to add dynamic promotions like (Add 3 more to get x% discount) on cart page for second language
    Given I am on "{spc_promotion_listing_page}"
    And I wait for the page to load
    When I follow "{language_link}"
    And I wait for the page to load
