...
Feature: SPC to checkout promotions (Free Gifts) on PDP page without coupon for Guest User
  ...
  @desktop
  Scenario: As a Guest, I should be able to checkout promotions on PDP page without coupon
  ...
  @language @test
  Scenario: As a Guest, I should be able to checkout promotions on PDP page without coupon in second language
    Given I am on "{spc_single_product_detail_page_no_coupon}"
    And I wait for the page to load
  ...
  @language @mobile
  Scenario: As a Guest, I should be able to checkout promotions on mobile for PDP page without coupon (mobile)
    Given I am on "{spc_single_product_detail_page_no_coupon}"
    And I wait for the page to load
    And the element "#block-content .free-gift-promotions" should exist
    And the element "#block-content .free-gift-promotions .free-gift-promo-list" should exist
