...
#    And I select "Kharj" from "edit-guest-delivery-home-address-shipping-area-parent"
#    And I wait for AJAX to finish
#    And I select "as salam" from "edit-guest-delivery-home-address-shipping-administrative-area"
...
#    When I enter a valid Email ID in field "edit-guest-delivery-home-address-shipping-organization"
#    And I fill in "edit-guest-delivery-home-address-shipping-mobile-number-mobile" with "555667733"
#    And I select "الخصاوية" from "edit-guest-delivery-home-address-shipping-area-parent"
#    And I wait for AJAX to finish
#    And I select "الخصاوية" from "edit-guest-delivery-home-address-shipping-administrative-area"
