...
curl -X POST \
  'https://hmkw-test.factory.alshaya.com/skus/list?_format=json' \
  -H 'Cache-Control: no-cache' \
...
//$base_url = 'https://local.alshaya-hmsa.com/ar/';
$base_url = 'https://hmsa-uat.factory.alshaya.com/ar';
//$base_url = 'https://hmkw-test.factory.alshaya.com/';
...
$grant_type = 'password';
$username = 'alshaya_magento';
$password = 'AlShAyA_MaGeNtO';
$token_api_url = $base_url . 'oauth/token?_format=json';
$images_api_url = $base_url . 'skus/list?_format=json&XDEBUG_SESSION_START=PHPSTORM';
...
$data = post($images_api_url, json_encode($data), $headers);
print_r($data);
print PHP_EOL;
