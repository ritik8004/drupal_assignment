...
Feature: SPC Checkout Home Delivery
  ...
  Scenario: As a Guest, I should be able to checkout using CC
    ...
    And I wait 2 seconds
    And I fill in an element having class ".spc-type-cc-number input" with "4111111111111111"
    And I fill in an element having class ".spc-type-expiry input" with "09/20"
    And I fill in an element having class ".spc-type-cvv input" with "123"
