@javascript
Feature: SPC Checkout Home Delivery
  ...
  Scenario: As a Guest, I should be able to checkout using COD
    ...
    And I fill in an element having class ".spc-type-cc-number input" with "4242424242424242"
    And I fill in an element having class ".spc-type-expiry input" with "05/22"
    And I fill in an element having class ".spc-type-cvv input" with "100"
