...
$command = "CACHE_PREFIX=$cache_directory AH_SITE_ENVIRONMENT=$env \drush8 -r $docroot -l https://$new_domain sqlq \"SHOW TABLES LIKE 'cache%'\" | xargs -I cache_table \drush8 -r $docroot -l https://$new_domain sqlq \"TRUNCATE TABLE cache_table\"";
