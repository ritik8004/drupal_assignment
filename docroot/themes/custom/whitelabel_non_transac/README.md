...
#### Setup sub-theme
- Install whitelabel_non_transac
  - `composer require drupal/whitelabel_non_transac`
  - `drush dl whitelabel_non_transac`
- Enable whitelabel_non_transac
  - `drush en whitelabel_non_transac`
- Generate a sub-theme
  - `drush whitelabel_non_transac sub_theme_name`
- Configure settings
