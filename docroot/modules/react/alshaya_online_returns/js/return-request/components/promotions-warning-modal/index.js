...
const PromotionsWarningModal = ({
  ...
  <div className="promotions-warning-modal-wrapper">
    ...
    <div className="description">
      <span>
        {Drupal.t('To receive refund for a promotional items, all items related to the promotion has to be returned.', {}, { context: 'online_returns' })}
      </span>
      <span>
    ...
    <div className="cta-wrapper">
      <button
        type="button"
        onClick={handlePromotionContinue}
      >
