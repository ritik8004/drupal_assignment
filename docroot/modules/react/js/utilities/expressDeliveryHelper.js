...
async function getExpressDeliveryStatus() {
  ...
  try {
    ...
    if (!hasValue(response.data) || hasValue(response.data.error)) {
      logger.warning('Warning occurred while fetching the express-delivery config for listing., Response: @response.', {
    ...
    logger.warning('Warning occurred while fetching the express-delivery config for listing. Message: @message.', {
