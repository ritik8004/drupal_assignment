...
class AlgoilaReactConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['add_to_bag_hover'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Enable add to bag hover effect on PLP product.'),
      '#default_value' => $config->get('add_to_bag_hover'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->configFactory->getEditable('alshaya_algolia_react.settings')
      ...
      ->set('add_to_bag_hover', $form_state->getValue('add_to_bag_hover'))
      ->save();
