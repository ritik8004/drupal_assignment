...
const GridButtons = ({
  ...
  <div className="grid-buttons">
    <div className={`large-col-grid ${drupalSettings.algoliaSearch.defaultColgrid === 'large' ? 'active' : ''}`} onClick={toggle}>
    ...
    <div className={`small-col-grid ${drupalSettings.algoliaSearch.defaultColgrid === 'small' ? 'active' : ''}`} onClick={toggle}>
