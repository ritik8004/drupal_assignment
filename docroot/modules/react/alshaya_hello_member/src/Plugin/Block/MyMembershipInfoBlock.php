...
/**
 * Provides My Membership info block.
 *
 * @Block(
 *   id = "my_membership_info_block",
 *   admin_label = @Translation("My Membership info block")
 * )
 */
class MyMembershipInfoBlock extends BlockBase implements ContainerFactoryPluginInterface {
