...
export default class FullScreenSVG extends React.Component {
  render() {
    if (this.props.mapFullScreen) {
      return (
        <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="74" height="74" viewBox="0 0 74 74">
          <defs>
      ...
      return (
        <svg xmlns="http://www.w3.org/2000/svg"
             xlink="http://www.w3.org/1999/xlink" width="74" height="74"
             viewBox="0 0 74 74">
          <defs>
            <path id="expand__b"
            ...
            <filter id="expand__a" width="136.5%" height="136.5%" x="-18.2%"
                    y="-18.2%" filterUnits="objectBoundingBox">
              <feOffset dy="3" in="SourceAlpha" result="shadowOffsetOuter1"/>
