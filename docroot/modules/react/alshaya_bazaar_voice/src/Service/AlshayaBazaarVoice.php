...
class AlshayaBazaarVoice {
  ...
  public function getBasicConfigurations($context = 'web') {
    ...
    if ($context === 'web') {
      ...
      $basic_configs['google_api_endpoint'] = array_key_exists('endpoint', $google_translations_api) ? $google_translations_api['endpoint'] : '';
      $basic_configs['google_api_key'] = array_key_exists('api_key', $google_translations_api) ? $google_translations_api['api_key'] : '';
    }
