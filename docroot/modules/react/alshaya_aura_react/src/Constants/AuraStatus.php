...
final class AuraStatus {
   ...
   */
  public const APC_NOT_LINKED_NO_DATA = 0;

  /**
   * No Linking but Data is present.
   */
  public const APC_NOT_LINKED_DATA = 1;

  /**
   * LINKED and VERIFIED Customers.
   */
  public const APC_LINKED_VERIFIED = 2;

  /**
   * LINKED but not Verified Customers.
   */
  public const APC_LINKED_NOT_VERIFIED = 3;

  /**
   * Not linked and No data in MDC.
   */
  public const APC_NOT_LINKED_NOT_U = 4;

  /**
   * Contains all the aura status in the class.
   */
  public const ALL_AURA_STATUS = [
