    ...
    switch ($context) {
      case 'plp':
        ...
        if ($sku->get('attr_product_designer_collection')->getString()) {
          $label = $sku->get('attr_product_designer_collection')
            ->getString();
          $plp_label = '<li class="attr_product_collection">' . $label . '</li>';
        }
        elseif ($sku->get('attr_product_collection')->getString()) {
          $label = $sku->get('attr_product_collection')
            ->getString();
          $plp_label = '<li class="attr_product_collection">' . $label . '</li>';
        }
        elseif ($sku->get('attr_product_environment')->getString()) {
          $label = $sku->get('attr_product_environment')
            ->getString();
          $plp_label = '<li class="attr_product_environment">' . $label . '</li>';
        }
        elseif ($sku->get('attr_product_quality')->getString()) {
          $label = $sku->get('attr_product_quality')
            ->getString();
          $plp_label = '<li class="attr_product_quality">' . $label . '</li>';
        }
      ...
      case 'pdp':
        ...
        if ($sku->get('attr_product_designer_collection')->getString()) {
          $label = $sku->get('attr_product_designer_collection')
            ->getString();
          $product_attribute_labels[] = '<li class="attr_product_collection">' . $label . '</li>';
        }
        if ($sku->get('attr_product_environment')->getString()) {
          $label = $sku->get('attr_product_environment')
            ->getString();
          $product_attribute_labels[] = '<li class="attr_product_environment">' . $label . '</li>';
        }
        ...
        if ($sku->get('attr_product_quality')->getString()) {
          $label = $sku->get('attr_product_quality')
            ->getString();
          $product_attribute_labels[] = '<li class="attr_product_quality">' . $label . '</li>';
        }
        $labels = implode('', $product_attribute_labels);
