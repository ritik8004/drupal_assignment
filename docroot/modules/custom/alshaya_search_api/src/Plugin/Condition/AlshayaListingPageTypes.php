  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($page_types as $page_type => $page_type_value) {
      $form['page_types'][$page_type] = [
        ...
        '#default_value' => (isset($this->configuration['page_types'][$page_type]))
          ? $this->configuration['page_types'][$page_type]
          : 0,
      ];
    }
    $form['show_on_selected_pages'] = [
      ...
      '#default_value' => (isset($this->configuration['show_on_selected_pages']))
        ? $this->configuration['show_on_selected_pages']
        : 0,
    ];
