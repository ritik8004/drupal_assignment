...
/**
 * Provides a custom block which contains/renders all facet blocks for Promo.
 *
 * @Block(
 *  id = "alshaya_promo_facets_block_all",
 *  admin_label = @Translation("Alshaya all facet block - Promo"),
 * )
 */
class AlshayaPromoFacetsBlock extends BlockBase implements ContainerFactoryPluginInterface {
