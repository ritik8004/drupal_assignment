...
/**
 * Plugin implementation of the 'sku_plain_text' formatter.
 *
 * @FieldFormatter(
 *   id = "sku_plain_text",
 ...
 * )
 */
class SkuPlainText extends FormatterBase implements ContainerFactoryPluginInterface {
