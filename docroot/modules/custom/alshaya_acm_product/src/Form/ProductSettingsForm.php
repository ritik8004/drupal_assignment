...
class ProductSettingsForm extends ConfigFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config->set('same_day_shipping_method', $form_state->getValue('same_day_shipping_method'));
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['product_flag']['same_day_shipping_method'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Same day delivery shipping method'),
      '#description' => $this->t('Please enter same day shipping method e.g. alshayadelivery_qd_qd01.'),
      '#default_value' => $config->get('same_day_shipping_method'),
    ];
