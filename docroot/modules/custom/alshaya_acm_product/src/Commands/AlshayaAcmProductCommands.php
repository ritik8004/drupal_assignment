...
class AlshayaAcmProductCommands extends DrushCommands {
  ...
  /**
   * Command to clean up brand product options.
   *
   * @param array $options
   *   Command options.
   *
   * @command alshaya_acm_product:clean-brand-product-options
   *
   * @option batch_size
   *   Batch size.
   *
   * @aliases clean-brand-product-options
   *
   * @usage clean-brand-product-options
   *   Clean up brand product options and re-create them.
   */
  public function cleanBrandProductOptions(array $options = ['batch_size' => 100]) {
    $batch_size = (int) $options['batch_size'];
  ...
  /**
   * Batch callback for deleteBrandProducListNodes.
   *
   * @param array $nids
   *   Nodes to delete.
   */
  ...
  /**
   * Batch callback for recreateProductOptionNodes.
   *
   * @param array $terms
   *   Terms to process.
   */
