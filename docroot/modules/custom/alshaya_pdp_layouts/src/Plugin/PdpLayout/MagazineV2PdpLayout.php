...
class MagazineV2PdpLayout extends PdpLayoutBase implements ContainerFactoryPluginInterface {
  ...
  public function getRenderArray(array &$vars) {
    ...
    $vars['#attached']['drupalSettings']['checkoutFeatureStatus'] = $checkout_feature_status;
    $vars['#attached']['drupalSettings']['cartMaxQty'] = $cart_max_qty;
    $vars['#attached']['drupalSettings']['cart_update_endpoint'] = _alshaya_spc_get_middleware_url() . '/cart/update';
