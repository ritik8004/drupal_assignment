 ...
 *
 * @PdpLayout(
 *   id = "product_category_carousel",
 *   label = @Translation("Product Category Carousel"),
 * )
 */
class ProductCategoryCarouselLayout extends PdpLayoutBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * ProductCategoryCarouselLayout constructor.
   *
