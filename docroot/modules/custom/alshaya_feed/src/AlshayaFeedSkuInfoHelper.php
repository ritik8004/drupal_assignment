  ...
  public function prepareFeedData(int $nid): array {
    ...
    foreach ($this->languageManager->getLanguages() as $lang => $language) {
      ...
      $parentProduct = [
        ...
        'short_description' => !empty($short_desc['value']) ? html_entity_decode($this->renderer->renderPlain($short_desc['value'])->__toString()) : '',
        'description' => !empty($description) ? html_entity_decode($this->renderer->renderPlain($description)->__toString()) : '',
