...
(function ($, Drupal) {
  ...
  Drupal.behaviors.sizegroupFilter = {
    ...
    attach: function (context, settings) {
      ...
      $('.show-all-filters').once('facet-show-all-for-sizegroup-processed').on('click', function() {
        Drupal.behaviors.sizegroupFilter.openSelectedSizeGroupFilter();
      });


      $('.sticky-filter-wrapper #block-plpsize ul li').once('show-size-filter').on('click tap', function (context) {
      ...
      $('.all-filters #block-plpsize >ul >li').on('click', function(event) {
        ...
        $('#all-filter-active-facet-sort').val($(this).children('ul').attr('id') + ',' + $(this).closest('.block-facets').attr('id'));
      ...
      $('.facet-all-back').once('facet-all-back-for-sizegroup-processed').on('click', function() {
        ...
        if($selectedGrandChild.length) {
          ...
          $selectedGrandChild.closest('.block-facets').find('.c-facet__title').trigger('click');
