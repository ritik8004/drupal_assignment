...
(function ($, Drupal, drupalSettings) {
  ...
  if (rcsPhGetPageType() !== 'product') {
    ...
    RcsEventManager.addListener('alshayaPageEntityLoaded', (e) => {
      var alterInitialDataLayerData = new CustomEvent('alterInitialDataLayerData', {detail: { data: () => dataLayerAttachment , page_entity : e.detail.entity }});
      document.dispatchEvent(alterInitialDataLayerData);
      window.dataLayer.push(dataLayerAttachment);
    });
  }
