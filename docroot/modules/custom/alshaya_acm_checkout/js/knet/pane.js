/**
 * @file
 * Attaches behaviors for the knet pane.
 */

(function($, Drupal, knet) {
  'use strict';

  Drupal.behaviors.knet = {
    attach: function(context, settings) {
      ...
      var knetSettings = settings.knet || {};
      var authorizationToken = knetSettings.authorizationToken;
