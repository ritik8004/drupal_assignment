...
class CheckoutTerms extends CheckoutPaneBase implements CheckoutPaneInterface {
  ...
  public function validatePaneForm(array &$pane_form, FormStateInterface $form_state, array &$complete_form) {
    ...
    if (empty($values['terms'])) {
      $form_state->setErrorByName('checkout_terms][terms', $this->t('Please agree to the Terms and Conditions.', [], ['context' => 'alshaya_error_message|agree_terms_and_condition']));
    }
  }
