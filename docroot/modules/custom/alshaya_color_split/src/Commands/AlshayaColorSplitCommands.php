...
namespace Drupal\alshaya_color_split\Commands;
...
class AlshayaColorSplitCommands extends DrushCommands {
  ...
  /**
   * AlshayaColorSplitCommands constructor.
   *
   ...
   *
   * @command alshaya_color_split:store_old_alias_sku_map
   *
   * @validate-module-enabled alshaya_color_split
   *
   * @aliases alshaya_color_split_store_old_alias_sku_map
   */
  ...
  public static function storeAliasFirstChildSkuMapping(&$context) {
    ...
    foreach ($rows as $row) {
      ...
      if (($sku_entity instanceof SKUInterface) &&
        ...
        $color_split_settings = \Drupal::configFactory()->get('alshaya_color_split.settings');
        $attribute_code_color_id = $color_split_settings->get('attribute_code_color_id');

        if (($firt_child_sku = $sku_manager->getFirstChildForSku($sku_entity, $attribute_code_color_id)) &&
   ...
   *
   * @command alshaya_color_split:add
   *
   * @validate-module-enabled alshaya_color_split
   *
   * @aliases alshaya_color_split_set_redirects
   */
  ...
  public static function addRedirectsFromTempstore(&$context) {
    $logger = \Drupal::logger('AlshayaColorSplitCommands');
