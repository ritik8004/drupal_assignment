(function ($) {
  Drupal.behaviors.alshaya_product_zoom = {
    attach: function (context, settings) {
      ...
      // Modal window for Slider-2, Image Gallery.
      ...
      // ZoomIn and out in Gallery view.
      ...
      $('#product-image-gallery li').click(function () {
        if($(this).hasClass('youtube') || $(this).hasClass('vimeo')) {
          ...
          $('#full-image-wrapper').empty();
          $('#full-image-wrapper').html('<iframe id="player" width="480" height="480" src="'
          ...
          $('#full-image-wrapper').empty();
          $('#full-image-wrapper').html('<img style="max-width: none;" id="full-image" src="' + bigImage + '" />');
        }
