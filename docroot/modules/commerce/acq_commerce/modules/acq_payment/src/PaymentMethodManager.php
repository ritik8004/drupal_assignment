...
class PaymentMethodManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/PaymentMethod', $namespaces, $module_handler, 'Drupal\acq_payment\Plugin\PaymentMethod\PaymentMethodInterface', 'Drupal\acq_payment\Annotation\ACQPaymentMethod');

    $this->alterInfo('acq_payment_method_info');
    $this->setCacheBackend($cache_backend, 'acq_payment_method_plugins');
  }
