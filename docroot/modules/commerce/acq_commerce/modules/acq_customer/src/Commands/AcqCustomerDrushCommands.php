...
class AcqCustomerDrushCommands extends DrushCommands {
  ...
  /**
   * AcqCustomerDrushCommands constructor.
   *
  ...
  public function __construct(Connection $connection,
    ...
    $this->setLogger($logger_factory->get('AcqCustomerDrushCommands'));
  }

  /**
   * Push all the customers available in Drupal to upstream system.
   *
   * @command acq_customer:push-customers
   *
  ...
  public function pushCustomersData() {
    ...
    $query->condition('acq_customer_id', 0, '>');
  ...
  public static function pushCustomerDataToUpstream(string $mail) {
    $logger = \Drupal::logger('AcqCustomerDrushCommands');
    ...
    elseif (empty($user->get('acq_customer_id')->getString())) {
