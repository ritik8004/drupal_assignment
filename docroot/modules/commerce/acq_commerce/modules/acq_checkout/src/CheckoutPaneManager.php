...
/**
 * Provides the ACQ Checkout Pane plugin manager.
 */
class CheckoutPaneManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/CheckoutPane', $namespaces, $module_handler, 'Drupal\acq_checkout\Plugin\CheckoutPane\CheckoutPaneInterface', 'Drupal\acq_checkout\Annotation\ACQCheckoutPane');

    $this->alterInfo('acq_checkout_pane_pane_info');
    $this->setCacheBackend($cache_backend, 'acq_checkout_pane_pane_plugins');
  }
