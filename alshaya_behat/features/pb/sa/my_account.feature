...
#    And I wait 2 seconds
  ...
  Scenario: As an authenticated user
    ...
    When I fill in "edit-search" with "PBSA"
    And I wait 2 seconds
    When I click the label for "#edit-submit-orders"
    And I wait for the page to load
    Then I should see at most "10" recent orders listed on orders tab
    And I should see all orders for "PBSA"
  ...
  I should be able to update my contact details
    ...
    And I wait for the page to load
    When I fill in "edit-field-first-name-0-value" with "Kanchan"
    When I fill in "edit-field-last-name-0-value" with "Test"
    When I fill in "edit-field-mobile-number-0-mobile" with "550123456"
    And I press "Save"
    And I wait for the page to load
    Then I should see "Kanchan"
    Then I should not see "550123456"
  ...
  Scenario: As an authenticated user
    ...
    When I fill in "field_address[0][address][mobile_number][mobile]" with "555123457"
    When I select "Abha" from "field_address[0][address][area_parent]"
    And I wait for AJAX to finish
    When I select "Abha" from "field_address[0][address][administrative_area]"
