...
Feature: Test Checkout feature
  ...
  I should be able to checkout using COD
    ...
    And I select "Abha" from "edit-guest-delivery-home-address-shipping-area-parent"
    And I wait for AJAX to finish
    And I select "Abha" from "edit-guest-delivery-home-address-shipping-administrative-area"
