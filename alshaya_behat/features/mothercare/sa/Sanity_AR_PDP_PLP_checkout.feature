...
Feature: As a guest user I should be able to
  ...
  PLP page and verify the fields on PDP page on arabic site
    ...
    Then I should see "خدمة التوصيل للمنزل"
    And I should see "خدمة التوصيل المجاني من 1-3 يوم إلى المدن الرئيسية ومن 1-5 أيام إلى المناطق الأخرى"
    And I should see "خدمة التوصيل المجاني للمحلات داخل المملكة السعودية العربية من 1 – 2 يوم"
    Then I should be able to see the footer in Arabic
    And I wait for AJAX to finish
...
#    Then I should not see "يرجى اختيار القسم المطلوب"
  ...
  as payment methods
    ...
    And I select "أحد رفيدة" from "edit-guest-delivery-home-address-shipping-area-parent"
    And I wait for AJAX to finish
    When I select "أحد رفيدة" from "edit-guest-delivery-home-address-shipping-administrative-area"
...
#    Then I should see "إعادة"
  ...
  and KNET as payment methods
    ...
    And I fill in "edit-cc-mobile-number-mobile" with "571123456"
    ...
    And I fill in "edit-billing-address-address-billing-mobile-number-mobile" with "571123456"
