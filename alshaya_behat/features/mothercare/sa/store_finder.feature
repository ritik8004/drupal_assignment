...
Feature: Test Store finder page
  ...
  On clicking a link from the list on Store finder page
    When I follow "773 Mothercare Roshan Mall"
    And I wait for the page to load
    Then I should see "773 Mothercare Roshan Mall"
    And I should see text matching "1 Roshana Mall"
    And I should see "Prince Mohammed Bin Abdulaziz St"
    And I should see "+966 12 2617600"
  ...
  On the list view mode which is by default selected on Store finder page
    When I select the first autocomplete option for "King Fahd Road, Jeddah Saudi Arabia" on the "edit-geolocation-geocoder-google-places-api" field
    And I wait for AJAX to finish
