...
Feature: Test the My account section for authenticated user
  ...
  by ID, name, SKU in combination with the Status of the order
    ...
    And I wait for the page to load
    When I fill in "edit-search" with "حاملة"
    When I click the label for "#edit-submit-orders"
    And I wait for the page to load
    Then I should see all "حاملة" orders
    When I fill in "edit-search" with "MCSA"
    And I wait 2 seconds
    When I click the label for "#edit-submit-orders"
    And I wait for the page to load
    And I should see all orders for "MCSA"
  ...
  I should be able to update my contact details
    ...
    When I fill in "edit-field-mobile-number-0-mobile" with "571343434"
    And I press "حفظ"
    And I wait for the page to load
    ...
    Then I fill in "edit-field-mobile-number-0-mobile" with "571343434"
    And I press "حفظ"
  ...
  to my address book
    ...
    When I select "الجبيل" from "field_address[0][address][area_parent]"
    And I wait for AJAX to finish
    When I select "الدانة الشماليه" from "field_address[0][address][administrative_area]"
