...
Feature: to verify search functionality , basket and checkout
  ...
  I should be able to search, verify filter,footer, header and sort on results page
    ...
    And I press "Search"
    And I wait for the page to load
    Then I should see Search results page for "sweatshirt"
  ...
  and verify the fields on basket
    ...
    Then I should see "Home delivery in 1 – 2 days to main cities. Delivery cost AED 25, or FREE on orders over AED 200."
    ...
    And I should be able to see the header
