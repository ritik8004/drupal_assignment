@javascript
  Feature: To verify my account, Sign in functionality
    ...
    I should be able to sign in after providing valid credentials and
      ...
      When I fill in "edit-name" with "trupti@axelerant.com"
    ...
    to my address book
      ...
      When I select "Dubai" from "field_address[0][address][area_parent]"
      And I wait for AJAX to finish
      And I select "Abu Hail" from "field_address[0][address][administrative_area]"
    ...
    I should be able to edit an address
      ...
      When I click Edit Address
      And I wait for AJAX to finish
      When I select "Abu Hail" from "field_address[0][address][administrative_area]"
    ...
    Examples:
      ...
      |/twill-shorts-high-waist-4|Home > Ladies > Shop By Concept > Divided > Twill Shorts High Waist|
      |/cart                                                 |Home > Basket                                                                                            |
