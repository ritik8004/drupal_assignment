...
#    Then I should not see the link "Learn more"
  ...
  I should be able to update my contact details
    ...
    When I fill in "edit-field-mobile-number-0-mobile" with "555687979"
    And I press "Save"
    ...
    When I fill in "edit-field-mobile-number-0-mobile" with "555797979"
    And I press "Save"
  ...
  Scenario: As an authenticated user
    ...
    When I fill in "field_address[0][address][mobile_number][mobile]" with "555687979"
    When I select "Jeddah" from "field_address[0][address][area_parent]"
    And I wait for AJAX to finish
    And I select "Abhur Al Janubiyah" from "field_address[0][address][administrative_area]"
  ...
  Scenario: As an authenticated user
    ...
    When I click Edit Address
    And I wait for AJAX to finish
    When I select "AI Barakah" from "field_address[0][address][administrative_area]"
