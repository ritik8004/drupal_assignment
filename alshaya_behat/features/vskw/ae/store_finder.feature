...
Feature: Test Store finder page
  ...
  On clicking a link from the list on Store finder page
    When I follow "852 Dareen Mall"
    And I wait for the page to load
    Then I should see "852 Dareen Mall"
    And I should see text matching "Dammam 32424"
    And I should see "Khaleej Rd, Al Aziziyah"
    And I should see "(+966) 13 8309187"
