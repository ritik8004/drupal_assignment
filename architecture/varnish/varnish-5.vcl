...
sub vcl_recv {
  ...
  #
  # See vcl-default/DOCUMENTATION.md#static-file-policy
  if (req.url ~ "(?i)/(modules|themes|files|libraries)/.*\.(html?|css|js|json|yml|xml|txt|gif|png|jpe?g|pdf|svg|ico|ogg|ogv|webm|mp3|mp4|mov|flv|f4v|swf|doc|ttf|eot|ppt|xls|otf|woff2?|tbz|bz2|rar)(\?.*)?$"
