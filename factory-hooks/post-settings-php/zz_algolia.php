...
$config['search_api.index.acquia_search_index']['options']['algolia_index_name'] = $settings['env'] . '_' . $acsf_site_name;
$config['block.block.autocompletewidgetofalgolia']['settings']['index'] = $settings['env'] . '_' . $acsf_site_name;
