...
#
# ./scripts/utilities/stack-migration-final.sh alshaya.01live vskw alshaya2.02live vskw2
...
if [[ -z "$source_env" ]]; then
  echo "Usage: ./scripts/utilities/stack-migration-final.sh SOURCE_ENV SOURCE_SITE_CODE TARGET_ENV TARGET_SITE_CODE"
  echo "Example: ./scripts/utilities/stack-migration-final.sh alshaya.01live vskw alshaya2.02live vskw2"
  exit
fi
